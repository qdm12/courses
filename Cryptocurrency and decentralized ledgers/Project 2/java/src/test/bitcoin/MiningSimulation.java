...
public class MiningSimulation {
    ...
    public void simulate51PercentAttack1() {
        Miner attacker = new MajorityMiner("Attacker", 520, 1); // has 52% of power
    ...
    public void simulate51PercentAttack2() {
        Miner attacker = new MajorityMiner("Attacker", 550, 1); // has 55% of power
    ...
    @Test
    public void simulateCustom_Majority1() {
        Miner attacker = new fm1UCkJwvKfQL7zEEA2Miner("Attacker", 55, 1); // 52.38%
        Miner miner2 = new CompliantMiner("Miner2", 5, 1);
        Miner miner3 = new CompliantMiner("Miner3", 5, 1);
        Miner miner4 = new CompliantMiner("Miner4", 10, 1);
        Miner miner5 = new CompliantMiner("Miner5", 15, 1);
        Miner miner6 = new CompliantMiner("Miner6", 15, 1);
        ...
        Map<String, Double> relativeProfits = runSimulation(miners, reward, ChurnFunction.NO_CHURN);
        double attackerProfits = relativeProfits.get(attacker.getId());
        Assertions.assertThat(attackerProfits).isGreaterThan(.55);
    }
    
    @Test
    public void simulateCustom_Selfish1() {
        Miner attacker = new fm1UCkJwvKfQL7zEEA2Miner("Attacker", 22, 1); // 30.5%
        Miner miner2 = new CompliantMiner("Miner2", 5, 1);
        Miner miner3 = new CompliantMiner("Miner3", 5, 1);
        Miner miner4 = new CompliantMiner("Miner4", 10, 1);
        Miner miner5 = new CompliantMiner("Miner5", 15, 1);
        ...
        Map<String, Double> relativeProfits = runSimulation(miners, reward, ChurnFunction.NO_CHURN);
        double attackerProfits = relativeProfits.get(attacker.getId());
        Assertions.assertThat(attackerProfits).isGreaterThan(.32);
    }
    
    @Test
    public void simulateCustom_FeeSniping1() {
        Miner attacker = new fm1UCkJwvKfQL7zEEA2Miner("Attacker", 36, 1); // 40%
        Miner miner2 = new CompliantMiner("Miner2", 5, 1);
        Miner miner3 = new CompliantMiner("Miner3", 5, 1);
        Miner miner4 = new CompliantMiner("Miner4", 10, 1);
        Miner miner5 = new CompliantMiner("Miner5", 15, 1);
        ...
        Map<String, Double> relativeProfits = runSimulation(miners, reward, ChurnFunction.NO_CHURN);
        double attackerProfits = relativeProfits.get(attacker.getId());
        Assertions.assertThat(attackerProfits).isGreaterThan(.44);
    }
    
    
    @Test
    public void simulateCustom_Compliant() {
        Miner attacker = new fm1UCkJwvKfQL7zEEA2Miner("Attacker", 11, 1); // 18%
        Miner miner2 = new CompliantMiner("Miner2", 5, 1);
        Miner miner3 = new CompliantMiner("Miner3", 5, 1);
        Miner miner4 = new CompliantMiner("Miner4", 10, 1);
        Miner miner5 = new CompliantMiner("Miner5", 15, 1);
        ...
        Map<String, Double> relativeProfits = runSimulation(miners, reward, ChurnFunction.NO_CHURN);
        double attackerProfits = relativeProfits.get(attacker.getId());
        Assertions.assertThat(attackerProfits).isGreaterThan(.17);
    }
