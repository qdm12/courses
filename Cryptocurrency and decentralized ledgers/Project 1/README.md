...
- You can use Eclipse for example as follows:
    ...
    4. Right click on `ScriptTests.java` then `Run as...` and `1 JUnit Test`
...
### Exercise 2
- Locking script
    - Transaction hex you can directly submit this to a block explorer:
        ```
    ...
    - Broadcasted transaction
        ```
        f8c1f5a09f5a129f69dda0ba0b0a7650dfe4f9a915890f44dc1f7021a6014ace
        ```
...
- Unlocking script
    ...
    - Broadcasted transaction
        ```
        c6790c526fd15ed18f7b0e77ceffb6f009689b46de097b9080b18752e8b34e9c
        ```
...
- Locking script
    ...
    - Broadcasted transaction
        ```
        20cf48b1e5fcc136b3439b714bafd634cabcb8b4638fbc4ca8948c203275fad8
        ```
...
- Unlocking script
    ...
    - Broadcasted transaction
        ```
        36af3d957640c4cc38719768d71e821ba23b0cf2b212f4a8947cc216e154392c
        ```